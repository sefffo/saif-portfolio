...
const projects = [
  ...
  },
  {
    ...
    description: 'Personal portfolio built with React 19, TypeScript, Three.js (R3F), GSAP ScrollTrigger, Tailwind v4, and React Router v7.',
    tech: ['React 19', 'TypeScript', 'Three.js', 'R3F', 'GSAP', 'Lenis', 'Tailwind v4', 'React Router v7'],
    ...
    highlights: [
      ...
      'GSAP ScrollTrigger animations on every section scroll-in',
      'Floating tech chips with continuous GSAP yoyo loop animations',
    ],
  },
  {
