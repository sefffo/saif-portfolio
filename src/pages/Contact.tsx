  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className="pointer-events-none absolute bottom-0 right-0 w-72 h-72 rounded-full"
        ...
        <div>
          ...
          <p className="cl-sub text-[#4b5563] text-sm leading-relaxed max-w-xs mb-14">
            ...
            and collaborations. Based in Cairo &mdash; available remotely worldwide.
          </p>
          ...
          <div className="flex flex-col gap-5">
            {SOCIALS.map(s => (
              ...
              >
                <span
                  className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0 bg-[#1e2235] text-[#374151] group-hover:bg-[#7c6aff]/20 group-hover:text-[#a78bfa] transition-all duration-300"
                >
                  {s.icon}
                </span>
                <div>
                ...
                <svg
                  ...
                  className="ml-auto text-[#1e2235] group-hover:text-[#7c6aff] transition-colors opacity-0 group-hover:opacity-100 -translate-x-1 group-hover:translate-x-0 transition-all duration-200"
                >
      ...
      {/* ═══════════════════════════ RIGHT PANEL ══════════════════════════ */}
      <div
        className="flex-1 flex items-center justify-center px-10 py-16 lg:px-16"
        ...
        <div className="cr-inner w-full max-w-xl">
          ...
          {status === 'sent' ? (
            <div className="flex flex-col items-center justify-center gap-6 py-20 text-center">
              ...
              <div>
                <p className="text-white font-black text-3xl uppercase tracking-tight mb-3">Message Sent!</p>
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-7" noValidate>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-2.5">
                    <label className="text-[9px] tracking-[0.45em] uppercase text-[#374151]">Name</label>
                    <input
                      type="text" required
                      value={form.name} onChange={set('name')}
                      placeholder="Your name"
                      className="w-full bg-transparent border-b border-[#1e2235] text-[#e8eaf0] text-sm py-3 focus:outline-none focus:border-[#7c6aff] transition-colors placeholder-[#272d42]"
                    />
                  </div>
                  <div className="flex flex-col gap-2.5">
                    <label className="text-[9px] tracking-[0.45em] uppercase text-[#374151]">Email</label>
                    <input
                      type="email" required
                ...
                <div className="flex flex-col gap-2.5">
                  <label className="text-[9px] tracking-[0.45em] uppercase text-[#374151]">Message</label>
                  <textarea
                    rows={7} required
                    value={form.message} onChange={set('message')}
                    placeholder="Tell me about your project or opportunity..."
                    className="w-full bg-transparent border-b border-[#1e2235] text-[#e8eaf0] text-sm py-3 focus:outline-none focus:border-[#7c6aff] transition-colors placeholder-[#272d42] resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  className="group relative overflow-hidden mt-2 w-full bg-[#7c6aff] text-white text-[11px] tracking-[0.35em] uppercase font-bold py-5 rounded-xl hover:bg-[#6c5ce7] active:scale-[0.99] transition-all duration-300 disabled:opacity-60 flex items-center justify-center gap-3"
                >
                  {/* shimmer */}
